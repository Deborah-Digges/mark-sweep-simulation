...
struct Object
{
	...
	/* This field is needed only for the pointer reversal procedure of object traversal
	 * It is used to indicate along which branch of a node traversal is currently proceeding
	*/
	int flag;
